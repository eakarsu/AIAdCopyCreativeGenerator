...
// v0 scaffold for: No direct ad-platform upload integration
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-direct-ad-platform-upload-integration/run.

export default function DirectAdPlatformUploadIntegrationPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-direct-ad-platform-upload-integration/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No direct ad-platform upload integration</h1>
