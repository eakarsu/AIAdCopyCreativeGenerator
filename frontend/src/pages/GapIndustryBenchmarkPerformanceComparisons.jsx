...
// v0 scaffold for: No industry-benchmark performance comparisons
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-industry-benchmark-performance-comparisons/run.

export default function IndustryBenchmarkPerformanceComparisonsPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-industry-benchmark-performance-comparisons/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No industry-benchmark performance comparisons</h1>
