...
// v0 scaffold for: Meta Ads, Google Ads, and HubSpot API connectors
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-meta-ads-google-ads-hubspot/run.

export default function MetaAdsGoogleAdsHubspotPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-meta-ads-google-ads-hubspot/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Meta Ads, Google Ads, and HubSpot API connectors</h1>
