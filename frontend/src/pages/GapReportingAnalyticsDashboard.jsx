...
// v0 scaffold for: No reporting / analytics dashboard
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-reporting-analytics-dashboard/run.

export default function ReportingAnalyticsDashboardPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-reporting-analytics-dashboard/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No reporting / analytics dashboard</h1>
