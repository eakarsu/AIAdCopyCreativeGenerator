...
// v0 scaffold for: Multi-language copy generation for non-English markets
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-multi-language-copy-generation-non/run.

export default function MultiLanguageCopyGenerationNonPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-language-copy-generation-non/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Multi-language copy generation for non-English markets</h1>
